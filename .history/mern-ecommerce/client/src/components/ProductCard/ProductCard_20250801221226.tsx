...
const ProductCard: React.FC<ProductCardProps> = ({ product = mockProduct, className = '' }) => {
  ...
  return (
    <div
      className={`group relative bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden h-full flex flex-col ${className}`}
    >
      ...
      <div className="relative aspect-square overflow-hidden flex-shrink-0">
        ...
        <div className="absolute bottom-3 right-3 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <button
            className="bg-white dark:bg-gray-700 p-2 rounded-full shadow-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
      ...
      <div className="p-3 sm:p-4 flex-1 flex flex-col">
        ...
        {/* Product Title */}
        <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 dark:text-white mb-2 line-clamp-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors flex-1">
          {product.title}
        </h3>
        ...
        <div className="flex items-center gap-2 mb-2 sm:mb-3">
          ...
          <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">({product.numReviews})</span>
        </div>
        ...
        <div className="flex items-center gap-2 mb-2 sm:mb-3">
          {hasDiscount ? (
            <>
              ...
              <span className="text-sm sm:text-base lg:text-lg text-gray-500 line-through">${product.price}</span>
            </>
          ) : (
            <span className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white">
              ${product.price}
