...
async function testProductRatingUpdate() {
  ...
  try {
    ...
    console.log(
      `   Before: Rating ${productBefore.averageRating}, Reviews ${productBefore.numReviews}`
    );
    ...
    if (response.data.success) {
      ...
      console.log(
        `   After: Rating ${productAfter.averageRating}, Reviews ${productAfter.numReviews}`
      );
